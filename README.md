...
class JonasRGoes:
    ...
    def __init__(self):
        ...
        self.position = 'Senior Full Stack Software Engineer'
        self.start_date = 1995
        self.birth_date = 1978
        self.code = {
...
- [December 24, 2006 - Permissões e Tipos de Arquivos no Linux](http://www.dicas-l.com.br/arquivo/permissoes_e_tipos_de_arquivos_no_linux.php#.YQvyZVNKg1I)
